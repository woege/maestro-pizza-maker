...
# Therefore he defines the follwing varaibles in the pizza industry known as "pizza menu greeks":
...
def delta_pizza_menu(menu: PizzaMenu) -> float:
    # TODO: implement the delta measure for a pizza menu
    pass


def gamma_pizza_menu(menu: PizzaMenu) -> float:
    # TODO: implement the gamma measure for a pizza menu
    pass


def vega_pizza_menu(menu: PizzaMenu) -> float:
